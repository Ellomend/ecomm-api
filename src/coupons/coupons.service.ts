    ...
    return {
      ...
      coupon: {
        ...
        image: {
          id: 925,
          original:
            'https://res.cloudinary.com/elloq/image/upload/v1665565175/srvc/prod/5x2x.png',
          thumbnail:
            'https://res.cloudinary.com/elloq/image/upload/v1665565175/srvc/prod/5x2x-thumbnail.jpg',
        },
        type: 'fixed',
        amount: 5,
